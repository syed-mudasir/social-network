...
$aname=  getuser($pid1, 'fname');
    ...
    <?php
    require_once '../include/db_connect.php';
       $sum=  mysql_query("select sum(plike) AS value_sum from post");  
    $row = mysql_fetch_assoc($sum); 
 $sum = $row['value_sum'];
 $sum1=  mysql_query("select sum(punlike) AS value_sum1 from post");  
    $row = mysql_fetch_assoc($sum1); 
 $sum1 = $row['value_sum1'];
 $sum2=  mysql_query("select sum(user_id) AS value_sum2 from user");  
    $row = mysql_fetch_assoc($sum2); 
 $sum2 = $row['value_sum2'];
 $sum3=  mysql_query("select sum(id) AS value_sum3 from groups");  
    $row = mysql_fetch_assoc($sum3); 
 $sum3 = $row['value_sum3'];
    ?>
  ...
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        ...
        <li><a href="table.php"><i class="icon-table"></i><span>Tabels</span> </a> </li>
              ...
              <div class="widget big-stats-container">
                <div class="widget-content">
                  ...
                  <div id="big_stats" class="cf">
                    <div class="stat"> <i class="icon-user"></i> <span class="value"><?php echo $sum2;?></span> </div>
                    <!-- .stat -->
                    
                    <div class="stat"> <i class="icon-thumbs-up-alt"></i> <span class="value"><?php echo $sum ?></span> </div>
                    <!-- .stat -->
                    
                    <div class="stat"> <i class="icon-thumbs-down-alt"></i> <span class="value"><?php echo $sum1 ?></span> </div>
                    <!-- .stat -->
                    
                    <div class="stat"> <i class="icon-group"></i> <span class="value"><?php echo $sum3; ?></span> </div>
                    <!-- .stat --> 
                  </div>
                </div>
                <!-- /widget-content --> 
...
<div class="footer">
  <div class="footer-inner">
    <div class="container">
      <div class="row">
        <div class="span12"> &copy; 2015 <a href="">Friends Portal  Admin Template</a>. </div>
        <!-- /span12 --> 
      </div>
      <!-- /row --> 
    </div>
